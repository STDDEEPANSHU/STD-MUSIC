...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "Powered By ➪ @STD_DEEPANSHU", fill="pink", font = font1, align ="left") 
            image4.text((670, 150), "STD MUSIC", fill="pink", font = font2, stroke_width=2, stroke_fill="pink", align ="left") 
